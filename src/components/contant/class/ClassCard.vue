...
<div @click="ItemClick">
 ...
 <el-card class="card" :body-style="{ padding: '0px' }" shadow="hover">
    <div class="box"><img class="image" :src="data.img" alt=""></div>
    <div class="txt">
      <div class="title">标题: {{data.title}}</div>
    <div class="username">
      发布者:
      {{data.username}}
      <el-rate
...
export default {
  ...
  methods: {
    ItemClick(){
      ...
      this.$router.push({path:'/class',query:{class_id:this.data.id,canChange:this.canChange}})
    }
  }
