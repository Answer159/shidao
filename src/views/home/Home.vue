<template>
  <div class="home">
    ...
    <el-row >
      <el-col :span = 20 :offset="2">
        <home-tab @changePage="changePage"></home-tab>
      </el-col>
    </el-row>
    <el-row>
    ...
    <el-row>
      <el-col :span="20" :offset="2">
        <recommand-class :questions="questionData" :classes="RecommandClassData" ref="recommendClass"></recommand-class>
      </el-col>
    </el-row>
    <el-row class="bottom">
      <el-col>
...
export default {
  ...
  methods:{
    changePage(value){
      this.$refs.recommendClass.flag = value;
    }
  },
  created(){
    GetData().then((res)=>{
      this.RecommandClassData = res.data.classVos;
      this.RecommandTeacherData = res.data.userInfos;
      this.CateListData = res.data.categories;
