  ...
  <div class="form">
    ...
    <el-form ref="form" class="contantOne" :model="classInfo" label-width="20%" size="medium" label-position="left" label-suffix=":">
      ...
      <el-form-item class="item" label="图片">
        <edit-image :flag="0" :class-id="id"   :image-urls="imgPaths" ref="ClassFormAvUpload"></edit-image>
      </el-form-item>
      ...
      <el-form-item  label="教学内容">
        <el-input type="textarea"  resize="none" v-model="classInfo.classContent" :maxlength="200" :show-word-limit="true"></el-input>
      </el-form-item>
...
import {GetFullClass} from "../../../network/classDetail";
