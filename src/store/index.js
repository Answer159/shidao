...
export default new Vuex.Store({
    state: {
        ...
        userData: {
            ...
            domainText: window.sessionStorage.getItem('domainText'),
    ...
    mutations: {
        ...
        SetUserState(state, userInfo) {
            state.userData.collectionClass = userInfo.collectionClass;
            state.userData.collectionQuestion = userInfo.collectionQuestion;
            state.login = userInfo.login;
            state.userData.userId = userInfo.userId;
            state.userData.domainText = userInfo.domainText;
            state.userData.userName = userInfo.userName;
            state.userData.userImg = userInfo.userImg;
            window.sessionStorage.setItem('collectionClass', userInfo.collectionClass);
            window.sessionStorage.setItem('collectionQuestion', userInfo.collectionQuestion);
            window.sessionStorage.setItem('userId', userInfo.userId);
            window.sessionStorage.setItem('domainText', userInfo.domainText);
        ...
        Logout(state) {
            ...
            window.sessionStorage.setItem('domainText', null);
